...
/* Primary_PEDALS_ADC_RANGES */
    ...
    Primary_PEDALS_ADC_RANGES primary_pedals_adc_ranges_s = { 17620.0, 54339.0, 15141.0, 62888.0 };
...
/* Primary_ACCELERATOR_PEDAL_VAL */
    ...
    Primary_ACCELERATOR_PEDAL_VAL primary_accelerator_pedal_val_s = { 34.0 };
...
/* Primary_BRAKE_PEDAL_VAL */
    ...
    Primary_BRAKE_PEDAL_VAL primary_brake_pedal_val_s = { 40.0 };
...
/* Primary_TIMESTAMP */
    ...
    Primary_TIMESTAMP primary_timestamp_s = { 1803411016.0 };
...
/* Primary_TLM_STATUS */
    ...
    Primary_TLM_STATUS primary_tlm_status_s = { -107, 54, 94.0, 238.0 };
...
/* Primary_SET_TLM_STATUS */
    ...
    Primary_SET_TLM_STATUS primary_set_tlm_status_s = { 50, -23, 113.0, 105.0 };
...
/* Primary_GPS_COORDS */
    ...
    Primary_GPS_COORDS primary_gps_coords_s = { -2296646761.746, 2014835687.022 };
...
/* Primary_GPS_TIME */
    ...
    Primary_GPS_TIME primary_gps_time_s = { 37220115.0 };
...
/* Primary_GPS_SPEED */
    ...
    Primary_GPS_SPEED primary_gps_speed_s = { 2670912337.566 };
...
/* Primary_HV_VOLTAGE */
    ...
    Primary_HV_VOLTAGE primary_hv_voltage_s = { 63629.0, 53376.0, 16185.0, 5500.0 };
...
/* Primary_HV_CURRENT */
    ...
    Primary_HV_CURRENT primary_hv_current_s = { 41165.0, 50.0 };
...
/* Primary_HV_TEMP */
    ...
    Primary_HV_TEMP primary_hv_temp_s = { 4325.0, 49251.0, 54201.0 };
...
/* Primary_STEER_STATUS */
    ...
    Primary_STEER_STATUS primary_steer_status_s = { 107, -18, 0.0 };
...
/* Primary_LV_CURRENT */
    ...
    Primary_LV_CURRENT primary_lv_current_s = { 64.0 };
...
/* Primary_LV_VOLTAGE */
    ...
    Primary_LV_VOLTAGE primary_lv_voltage_s = { 202.0, 142.0, 75.0, 158.0, 40511.0 };
...
/* Primary_LV_TEMPERATURE */
    ...
    Primary_LV_TEMPERATURE primary_lv_temperature_s = { 203.0, 0, 37652.0 };
...
/* Primary_COOLING_STATUS */
    ...
    Primary_COOLING_STATUS primary_cooling_status_s = { 92.0, 95.0, 235.0 };
...
/* Primary_HV_CELLS_VOLTAGE */
    ...
    Primary_HV_CELLS_VOLTAGE primary_hv_cells_voltage_s = { 246.0, 0, 4680.0, 11173.0, 36279.0 };
...
/* Primary_HV_CELLS_TEMP */
    ...
    Primary_HV_CELLS_TEMP primary_hv_cells_temp_s = { 92.0, 66.0, 60.0, 147.0, 18.0, 126.0, 229.0, 177.0 };
...
/* Primary_SET_CHG_POWER */
    ...
    Primary_SET_CHG_POWER primary_set_chg_power_s = { 37992.0, 20550.0 };
...
/* Primary_CHG_STATUS */
    ...
    Primary_CHG_STATUS primary_chg_status_s = { 113 };
...
/* Primary_SET_CHG_STATUS */
    ...
    Primary_SET_CHG_STATUS primary_set_chg_status_s = { 14 };
...
/* Primary_CHG_SETTINGS */
    ...
    Primary_CHG_SETTINGS primary_chg_settings_s = { 250.0 };
