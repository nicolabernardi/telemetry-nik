...
/* bms_BOARD_STATUS */
    ...
    bms_BOARD_STATUS bms_board_status_s = { 231.0, {183}, -107 };
...
/* bms_TEMP_STATS */
    ...
    bms_TEMP_STATS bms_temp_stats_s = { 150.0, 92.0, 55.0, 220.0 };
...
/* bms_BALANCING */
    ...
    bms_BALANCING bms_balancing_s = { 106.0, {94, 101, 149} };
...
/* bms_MASTER_SYNC */
    ...
    bms_MASTER_SYNC bms_master_sync_s = { 3808560576.0 };
...
/* bms_VOLTAGES_0 */
    ...
    bms_VOLTAGES_0 bms_voltages_0_s = { 239.0, 0, 43429.0, 15714.0, 54304.0 };
...
/* bms_VOLTAGES_1 */
    ...
    bms_VOLTAGES_1 bms_voltages_1_s = { 19.0, 0, 36194.0, 23113.0, 58738.0 };
...
/* bms_VOLTAGES_2 */
    ...
    bms_VOLTAGES_2 bms_voltages_2_s = { 21.0, 0, 36230.0, 54485.0, 23378.0 };
...
/* bms_VOLTAGES_3 */
    ...
    bms_VOLTAGES_3 bms_voltages_3_s = { 138.0, 0, 19503.0, 4846.0, 10468.0 };
...
/* bms_VOLTAGES_4 */
    ...
    bms_VOLTAGES_4 bms_voltages_4_s = { 72.0, 0, 47516.0, 40440.0, 40639.0 };
...
/* bms_VOLTAGES_5 */
    ...
    bms_VOLTAGES_5 bms_voltages_5_s = { 132.0, 0, 46858.0, 34417.0, 9901.0 };
